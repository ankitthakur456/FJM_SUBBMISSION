...
MOde_Selection = {
    '1': {'137': '945', '138': '946', '139': '947', '140': '946', '141': '944', '142': '945',
          '143': '947', '144': '950', '145': '948', '146': '947', '147': '946', '148': '945',
...
def on_message(client_, userdata, message):
    global GL_CURRENT_KWH, GL_SERIAL_NUMBER_LIST, GL_DEQUEUE_SERIAL
    ...
    try:
        if message.topic == TRIGGER_TOPIC:  # if message is from trigger topic for serial number
            if data is not None:
                ...
                if result_line == 'B' and data[0]["machineId"] == "MC-04":
