...
class DBHelper:
    ...
    def get_serial_numbers(self, number_of_serials):
        try:
            query = f"""SELECT serial_number FROM queue ORDER BY timestamp ASC LIMIT {number_of_serials}"""
    ...
    def get_first_serial_number1(self,number_of_serials):
        try:
            serial_numbers = []
